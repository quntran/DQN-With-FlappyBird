...
class Agent():
    ...
    def run(self, is_training=True, render=False):
        ...
        policy_dqn = DQN(num_states, num_actions, self.fc1_nodes, self.fc2_nodes, self.enable_double_dqn).to(device)
        ...
        if is_training:
            ...
            target_dqn = DQN(num_states, num_actions, self.fc1_nodes, self.fc2_nodes, self.enable_double_dqn).to(device)
